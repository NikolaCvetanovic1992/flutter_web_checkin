...
/// @nodoc
mixin _$Preferences {
  @JsonKey(name: 'select_all_enabled')
  bool get selectAllEnabled => throw _privateConstructorUsedError;
...
abstract class $PreferencesCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'select_all_enabled') bool selectAllEnabled});
}
...
class _$PreferencesCopyWithImpl<$Res, $Val extends Preferences>
  ...
  @override
  $Res call({
    Object? selectAllEnabled = null,
  }) {
    return _then(_value.copyWith(
      selectAllEnabled: null == selectAllEnabled
          ? _value.selectAllEnabled
          : selectAllEnabled // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$PreferencesImpl implements _Preferences {
  _$PreferencesImpl(
      {@JsonKey(name: 'select_all_enabled') this.selectAllEnabled = false});
  ...
  @override
  String toString() {
    return 'Preferences(selectAllEnabled: $selectAllEnabled)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.selectAllEnabled, selectAllEnabled) ||
                other.selectAllEnabled == selectAllEnabled));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, selectAllEnabled);
...
abstract class _Preferences implements Preferences {
  factory _Preferences(
          {@JsonKey(name: 'select_all_enabled') final bool selectAllEnabled}) =
      _$PreferencesImpl;
